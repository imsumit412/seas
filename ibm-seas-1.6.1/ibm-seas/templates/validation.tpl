...
{{- $isValid := toString .Values.storageSecurity.rootSquashCheck -}}
{{- if ne $isValid "true" -}}
{{- fail "Configuration Error: Please provide a valid value for field Values.storageSecurity.rootSquashCheck. Set this field to true to acknowledge the rootSquash requirements for this chart." -}}
{{- end -}}
